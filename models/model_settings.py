# python3.7
"""Contains basic configurations for models_cy used in this project.

Please download the public released models_cy from the following two repositories
OR train your own models_cy, and then put them into `pretrain` folder.
